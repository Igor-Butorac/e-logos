            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="type_of_user" class="col-md-4 col-form-label text-md-right">{{ __('Tip korisnika') }}</label>

                            <div class="col-md-6">
                                <input id="type_of_user" type="type_of_user" class="form-control @error('type_of_user') is-invalid @enderror" name="type_of_user" required autocomplete="new-type_of_user">
